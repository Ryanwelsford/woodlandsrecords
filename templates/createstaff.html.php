                ...
                <div class="inner">
                    <div id="Status" class="w3-container city">
                        <div class="data">
                            ...
                            <label for="dor">Reason for dormancy: </label> <textarea id="dor" name="dormancy"></textarea>
                        </div>    
                    </div>
                    ...
                    <div id="Pinfo" class="w3-container city" style="display:none">
                        <div class="data">
                            <p></p>
                            <p></p>
                            <label id="fname">First name: </label> <input type="text" name="firstname" id="fname">
                            <label id="mname">Middle name: </label> <input type="text" name="middlename" id="mname">
                            <label id="sname">Surname: </label> <input type="text" name="surname" id="sname">
                            <label id="id">Staff ID: </label> <input type="text" name="staffid" id="id">
                        </div>
                    </div>
                    ...
                    <div id="Contact" class="w3-container city" style="display:none">
                        <div class="data">
                            <p></p>
                            <p></p>
                            <label for="add">Address: </label> <textarea id="add" name="address"></textarea>
                            <label for="num">Phone Number: </label> <input type="text" name="phonenum" id="num">
                            <label for="em">Email Address: </label> <input type="text" name="email" id="em">
                        </div>
                    </div>
                    ...
                    <div id="Academic" class="w3-container city" style="display:none">
                        <div class="data">
                            <p></p>
                            <p></p>
                            <label for="ro">Roles: </label> <textarea name="roles" id="ro"></textarea>
                            <label for="spe">Specailist Subjects: </label> <textarea name="specialsub" id="spe"></textarea>
                        </div>
                    </div>
                </div>
            </div>
